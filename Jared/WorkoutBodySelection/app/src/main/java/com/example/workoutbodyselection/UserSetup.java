...
public class UserSetup extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public static String goalInputVar;
    public static String levelInputVar;
...
//                        });
    ...
    public void confirmUserInput(View v) throws IOException {
        ...
        goalInputVar = goalInput.getSelectedItem().toString();
        levelInputVar = levelInput.getSelectedItem().toString();
